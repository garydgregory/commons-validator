 ...
 *
 * <p>Pick the appropriate validator, depending on the type (that is, Float, Double or BigDecimal)
 ...
 *    and BigInteger) since percentages are converted to fractions (for example, {@code 50%} is
